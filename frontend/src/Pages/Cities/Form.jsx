              ...
              <div className="row mb-3">
                <div className="col-8">
                  ...
                  <input
                    ...
                    onChange={({ target }) =>
                      setCity((_) => ({ ..._, NomeMunicipio: target.value }))
                    }
                  />
                </div>
                <div className="col">
                  ...
                  <select
                    ...
                    onChange={({ target }) =>
                      setCity((_) => ({
                        ..._,
                        idUnidadeFederativa: target.value,
                      }))
                    }
                  >
                    {federativeUnits.map((federativeUnit) => (
                      <option
                        ...
                        federative-unit-id={federativeUnit.idUnidadeFederativa}
                        value={federativeUnit.idUnidadeFederativa}
                      >
                        {federativeUnit.NomeUnidadeFederativa}
                      </option>
                    ))}
                  </select>
                </div>
                ...
                <div className="col">
                  <div className="form-check form-switch">
                    <input
                      ...
                      checked={city.ativo}
                      onChange={({ target }) =>
                        setCity((_) => ({ ..._, ativo: target.checked }))
                      }
                    />
