          ...
          <div className="col col-lg-5">
            <div className="input-group flex-nowrap">
              ...
              <select
                ...
                onChange={({ target }) => setFederativeUnitID(target.value)}
              >
                    ...
                    <tbody>
                      {cities.map((city) => (
                        <tr
                          ...
                          city-id={city.idMunicipio}
                          unit-id={city.idUnidadeFederativa}
                        >
                          <td>
                          ...
                          <td className="text-end">
                            <div className="dropdown">
                              <button
                                className="btn btn-sm dropdown-toggle px-3"
                                type="button"
                              ...
                              <ul className="dropdown-menu dropdown-menu-end">
                                <li>
                                  <Link
                                    ...
                                    to={`/cidades/editar/${city.idMunicipio}`}
                                  >
                                    <IconPencil
                                      className="icon me-2"
                                      stroke={1}
